...
class MainPageLocators:
    QUESTION_LOCATOR = (By.XPATH, "//div[@class='accordion__button' and @id='accordion__heading-{}']")
    ANSWER_LOCATOR = (By.XPATH, "//div[@class='accordion__panel' and @id='accordion__panel-{}']")
